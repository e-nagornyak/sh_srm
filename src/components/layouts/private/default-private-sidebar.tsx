...
export function DefaultPrivateSidebar() {
  ...
  return (
    <div
      className={cn(
        "group/sidebar bg-sidebar text-sidebar-foreground flex shrink-0 flex-col overflow-hidden border-r border-black border-border p-2 shadow-md duration-500",
        openSidebar ? "w-52 pt-0" : "w-12"
      )}
    >
      <Logo
