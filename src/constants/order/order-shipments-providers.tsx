...
interface OrderShipmentProvider {
  key: ListOfProvidersKeys
  displayName: string
  controller: FunctionComponent
}

const listOfProviders: { [key in ListOfProvidersKeys]: OrderShipmentProvider } =
  {
    allegro: {
      key: "allegro",
      displayName: "Allegro",
...
const orderShipmentProvidersMap = Object.entries(listOfProviders)
  .filter(([key]) => providers?.includes(key as ListOfProvidersKeys))
  .map(([, value]) => value)

export { orderShipmentProvidersMap, type OrderShipmentProvider }
